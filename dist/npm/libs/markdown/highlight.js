  ...
  function t(e) {
    ...
    function s(e, t) {
      ...
      w.cN && (C = p(w.cN, "", !0) + C);
        ...
        M = 0;try {
      for (var L, R, A = 0;;) {
        if (N.t.lastIndex = A, L = N.t.exec(r), !L) break;R = h(r.substr(A, L.index - A), L[0]), A = L.index + R;
    ...
    var t = "[a-zA-Z_]\\w*[!?=]?|[-+~]\\@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?",
        ...
        l = [c, n, { cN: "class", bK: "class module", e: "$|;", i: /=/, c: [e.inherit(e.TM, { b: "[A-Za-z_]\\w*(::\\w+)*(\\?|\\!)?" }), { b: "<\\s*", c: [{ b: "(" + e.IR + "::)?" + e.IR }] }].concat(i)
