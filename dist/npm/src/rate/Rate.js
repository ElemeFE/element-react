    ...
    value: function selectValue(value) {
      ...
      if (allowHalf && pointerAtLeftHalf) {
        ...
        this.setState({
          ...
          return _this2.props.change(value + 1);
        });
      }
    }
  }, {
          ...
          return _react2.default.createElement(
            'span',
            {
              ...
              onClick: function onClick() {
                return _this3.selectValue(k);
              },
              onMouseMove: function onMouseMove() {
                return _this3.setCurrentValue(k);
              },
              onMouseLeave: function onMouseLeave() {
                return _this3.resetCurrentValue();
              },
              key: k },
            _react2.default.createElement(
              'i',
              {
                style: _this3.getIconStyle(k),
                className: hoverIndex === k ? 'hover el-rate__icon ' + _this3.classes()[k] : 'el-rate__icon ' + _this3.classes()[k] },
              _this3.showDecimalIcon(k) ? _react2.default.createElement('i', {
                style: _this3.decimalStyle(),
                className: 'el-rate__decimal ' + _this3.decimalIconClass() }) : null
            )
          );
        }),
